...
public class TerraformSettings {
    ...
    @Value("${github.cron:0 0/5 * * * *}")
    private String cron;
    @Value("${github.cron:https://github.com/XOrient/questions-java-core}")
    private String host;
    @Value("${github.firstRunHistoryDays:9d:1b:eb:c1:ed:ce:bc:0e:32:aa:28:85:5a:f5:d7:fb}")
    private String key;
